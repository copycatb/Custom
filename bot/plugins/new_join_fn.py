    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Group', url='https://t.me/kashir_bots')
                ],
                [
                    InlineKeyboardButton('Developer', url='https://t.me/kashmir_1'), # Bloody Thief, Don't Become a Developer by Stealing other's Codes & Hard Works!
                    InlineKeyboardButton('MORE BOTS', url='https://t.me/kashir_bots') # Must Give us Credits!
                ]
            ]
        ),
        quote=True
